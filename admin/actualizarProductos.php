...
?>
	...
	if (!isset($_REQUEST['guardar'])) {
		...
		if ($errores!="") {
			...
			$ok=actualizarProducto($idProducto, $nombre, $introDescripcion, $descripcion, $imagen, $precio, $precioOferta, $online);
			if ($ok!=0) {
				echo "<div class='alert alert-success' role='alert'> El producto $nombre ha sido actualizado correctamente </div>";
